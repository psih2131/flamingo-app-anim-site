<template>
    <header class="header">
        <div class="container">
            ...
            <nav class="header__nav-wrapper">
                <ul class="header__nav-list">
                    <li class="header__nav-element">
                        <nuxt-link no-prefetch to="/about" class="header__nav-element-link">About</nuxt-link>
                    </li>
                    <li class="header__nav-element">
                        <nuxt-link no-prefetch to="/blog" class="header__nav-element-link">Blog</nuxt-link>
                    </li>
                    <li class="header__nav-element">
                        <nuxt-link no-prefetch to="/" class="header__nav-element-link">Home</nuxt-link>
                    </li>
                </ul>
            ...
            <div class="header__burger-wrapper"></div>

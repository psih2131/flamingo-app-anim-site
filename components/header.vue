    ...
    >
        <div class="container">
            ...
            <nav class="header__nav-wrapper">
                ...
                <nuxt-link no-prefetch :to="localePath('/')" class="header__nav-logo">
                    <svg width="54" height="54" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="54" height="54" rx="22" fill="#EDEFF1"/>
                    ...
                    <div class="container">
                        <ul class="mob-meny__nav-list">
                          ...
                          <li class="mob-meny__nav-list-element">
                            ...
                            <li class="mob-meny__nav-list-element">
                                <nuxt-link no-prefetch :to="localePath('/#Blog')" class="mob-meny__nav-list-element-link">{{ $t('blog') }}</nuxt-link>

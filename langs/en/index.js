export default {
    ...
    footer_text2 : "Always consult with your legal advisor and tax consulting about specific requirements for your residency and visa status.",
    ...
    faq_a3:  'Rest assured,all data entered or automatically recorded in the app is encrypted by Apple and stored solely on your device or Apple\'s secure data services (iCloud), depending on your app settings. We do not have accessnor storeyour data on our servers and that is whywe do not requireregistration in the app.Moreover, Flamingo nevertracksyour precise location. Instead, we use city-level geolocationto determine your general location for the purpose of recording your movements between countries, US statesand cities. This approach ensures complete privacy for you and barely has any impact on yourbattery power. Improve this question and reply for the Flamingo app website FAQ section by adding that we do not upload or see any of the photos, but only scan their location and date data, so the scanning process takes just a few minutes. ',
    faq_a4:  'Yes, you can add your past travel information to the app. There are two ways to do this: manually add each trip to your timeline one-by-one, or if you usually take manyphotos, you can automatically reconstruct your travel history by scanning your Photo Library. We do not upload or see any of your photos; we only scan their location and timestampinformation, so the scanning process takes just a few minutes.',
    faq_a5:  "As a free user of the Flamingo app, you are allowed to enter up to fivetravel entries. This includes both manually entered trips (completed trips) and automatically tracked trips (new trips). Once you reach this limit, you will need to either delete some of the existing entries to add new ones or consider upgrading to a paid subscription for unlimited trip tracking and report feature.",
    ...
    help10: 'South Africa’sphysical presence rule',
    ...
    index_expats_texts : "Flamingo keeps tabs on the number of days and nights spent in your country of residence, proving to be an essential tool for global expats, overseas homeowners, digital nomads, and permanent residentslooking for an efficient way to manage their residency obligations.",
    index_tax : "Tax",
    ...
    index_ft_text : "Flamingo automatically records your border crossings into different countries and US states, whilediligently trackingyour visas and visa-free staylimits. Whether you travel for business or leisure, the app allows you to view and manage your trip history, add details, and plan upcomingjourneys. ",
    index_i : "International",
    index_s : "Students",
    index_is_text : "Flamingo simplifies life for international students by managing stays in a foreign country and overseeing adherence to student visa requirements. Itsfuture trip planning capabilities allow youto organize yourtravels efficiently, ensuring abalance between your studies andexploration or home visits.",

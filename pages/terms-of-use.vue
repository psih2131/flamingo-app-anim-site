        ...
        <section class="legal-sec">
            <div class="container">
                <div class="legal-container">
                  <div class="privacy-policy__headline">
                    <p class="legal-sec__date">Last updated November 10, 2022</p>
                    <h1 class="legal-sec__title">Terms of Use</h1>
                  </div>
                  <div class="legal-sec__text-wrapper text-container">
                    <h2>TABLE OF CONTENTS</h2>
                    <div>
                        <div v-for="(title, key) in titles" :key="key" @click="scrollTo(`${title.value}`)" style="cursor: pointer;" class="table_of_contents">{{ title.text }}</div>
                    </div>
                    <p></p>

                    <div class="agreementToTerms">
                      <h2>1. AGREEMENT TO TERMS</h2>
                      <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and AccuraSoft Ltd., doing business as "Flamingo – Travel Days Tracker app" ("Flamingo", "Flamingo Tracker", "Flamingo – Travel Days Tracker", “we”, “us”, or “our”), concerning your access to and use of the https://flamingotracker.com website and our mobile application (Flamingo – Travel Days Tracker) as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Service”). We are registered in the United Kingdom and have our registered office at 71-75 Shelton Street, London WC2H 9JQ. Our VAT number is GB354336794. You agree that by accessing the Service, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                      <p>Supplemental terms and conditions or documents that may be posted on the Service from time to time are hereby expressly incorporated herein by reference. We reserve the right, in our sole discretion, to make changes or modifications to these Terms of Use from time to time. We will alert you about any changes by updating the “Last updated” date of these Terms of Use, and you waive any right to receive specific notice of each such change. Please ensure that you check the applicable Terms every time you use our Service so that you understand which Terms apply. You will be subject to, and will be deemed to have been made aware of and to have accepted, the changes in any revised Terms of Use by your continued use of the Service after the date such revised Terms of Use are posted.</p>
                      ...
                      <p>The Service is not tailored to comply with industry-specific regulations (Health Insurance Portability and Accountability Act (HIPAA), Federal Information Security Management Act (FISMA), etc.), so if your interactions would be subjected to such laws, you may not use this Service. You may not use the Service in a way that would violate the Gramm-Leach-Bliley Act (GLBA).</p>
                    ...
                    <div class="userRepresentations">
                      <h2>3. USER REPRESENTATIONS</h2>
                      <p>By using the Service, you represent and warrant that: (1) you have the legal capacity and you agree to comply with these Terms of Use; (2) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Service; (3) you will not access the Service through automated or non-human means, whether through a bot, script or otherwise; (4) you will not use the Service for any illegal or unauthorized purpose; and (5) your use of the Service will not violate any applicable law or regulation.</p>
                    ...
                    <div class="feesAndPayment">
                      <h2>4. FEES AND PAYMENT</h2>
                      <p>We accept payment via the Apple App Store billing service.</p>
                      <p>You may be required to purchase or pay a fee to access some of our services. You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Service. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. We bill you through your Apple App Store billing account for purchases made via the Service. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in the local currency.</p>
                      ...
                      <p>We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or received payment. We also reserve the right to refuse any order placed through the Service.</p>
                    </div>

                    <div class="cancellation">
                      <h2>5. CANCELLATION</h2>
                      <p>All purchases are non-refundable. You can cancel your subscription at any time via Apple App Store billing service. Your cancellation will take effect at the end of the current paid term.</p>
                      <p>If you are unsatisfied with our services, please give us feedback through the contact form on our website or email us at contact@flamingotracker.com.</p>
                    </div>
                    ...
                    <div class="prohibitedActivities">
                      <h2>7. PROHIBITED ACTIVITIES</h2>
                      <p>You may not access or use the Service for any purpose other than that for which we make the Service available. The Service may not be used in connection with any commercial endeavours except those that are specifically endorsed or approved by us.</p>
                      ...
                      <ul>
                        ...
                        <li>Make any unauthorized use of the Service, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretences.</li>
                        <li>Use the Service as part of any effort to compete with us or otherwise use the Service and/or the Content for any revenue-generating endeavour or commercial enterprise.</li>
                      </ul>
                    </div>

                    <div class="userGeneratedContributions">
                      <h2>8. USER GENERATED CONTRIBUTIONS</h2>
                      <p>The Service may invite you to chat, contribute to, or participate in public blogs, message boards, online forums, and other functionality additional to the main Service, and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute, or broadcast content and materials to us or on the Service, including but not limited to text, writings, video, audio, photographs, graphics, comments, suggestions, or personal information or other material (collectively, "Contributions"). Contributions may be viewable by other users of the Service and through third-party websites. As such, any Contributions you transmit may be treated as non-confidential and non-proprietary. When you create or make available any Contributions, you thereby represent and warrant that:</p>
                      <ul>
                        <li>The creation, distribution, transmission, public display, or performance, and the accessing, downloading, or copying of your Contributions do not and will not infringe the proprietary rights, including but not limited to the copyright, patent, trademark, trade secret, or moral rights of any third party.</li>
                        <li>You are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, the Service, and other users of the Service to use your Contributions in any manner contemplated by the Service and these Terms of Use.</li>
                        <li>You have the written consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by the Service and these Terms of Use.</li>
                      ...
                      <p>Any use of the Service in violation of the foregoing violates these Terms of Use and may result in, among other things, termination or suspension of your rights to use the Service.</p>
                    </div>

                    <div class="contributionLicense">
                      <h2>9. CONTRIBUTION LICENSE</h2>
                      <p>By posting your Contributions to any public part of the Service, you automatically grant, and you represent and warrant that you have the right to grant, to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right, and license to host, use, copy, reproduce, disclose, sell, resell, publish, broadcast, retitle, archive, store, cache, publicly perform, publicly display, reformat, translate, transmit, excerpt (in whole or in part), and distribute such Contributions (including, without limitation, your image and voice) for any purpose, commercial, advertising, or otherwise, and to prepare derivative works of, or incorporate into other works, such Contributions, and grant and authorize sublicenses of the foregoing. The use and distribution may occur in any media formats and through any media channels.</p>
                    ...
                    <div class="mobileApplicationLicense">
                    ...
                    <div class="usGovernmentRights">
                      <h2>12. U.S. GOVERNMENT RIGHTS</h2>
                      <p>Our services are “commercial items” as defined in Federal Acquisition Regulation (“FAR”) 2.101. If our services are acquired by or on behalf of any agency not within the U.S. Department of Defense (“DOD”), our services are subject to the terms of these Terms of Use in accordance with FAR 12.212 (for computer software) and FAR 12.211 (for technical data). If our services are acquired by or on behalf of any agency within the Department of Defense, our services are subject to the terms of these Terms of Use in accordance with Defense Federal Acquisition Regulation (“DFARS”) 227.7202-3. In addition, DFARS 252.227-7015 applies to technical data acquired by the DOD. This U.S. Government Rights clause is in lieu of, and supersedes, any other FAR, DFARS, or other clause or provision that addresses government rights in computer software or technical data under these Terms of Use.</p>
                    </div>

                    <div class="serviceManagement">
                      <h2>13. SERVICE MANAGEMENT</h2>
                      <p>We reserve the right, but not the obligation, to: (1) monitor the Service for violations of these Terms of Use; (2) take appropriate legal action against anyone who, in our sole discretion, violates the law or these Terms of Use, including without limitation, reporting such user to law enforcement authorities; (3) in our sole discretion and without limitation, refuse, restrict access to, limit the availability of, or disable (to the extent technologically feasible) any of your Contributions or any portion thereof; (4) in our sole discretion and without limitation, notice, or liability, to remove from the Service or otherwise disable all files and content that are excessive in size or are in any way burdensome to our systems; and (5) otherwise manage the Service in a manner designed to protect our rights and property and to facilitate the proper functioning of the Service.</p>
                    </div>

                    <div class="privacyPolicy">
                      <h2>14. PRIVACY NOTICY</h2>
                      <p>We care about data privacy and security. Please review our Privacy Policy: flamingotracker.com/privacy. By using the Service, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Service is hosted in the United Kingdom. If you access the Service from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United Kingdom, then through your continued use of the Service, you are transferring your data to the United Kingdom, and you agree to have your data transferred to and processed in the United Kingdom.</p>
                    </div>
                    
                    <div class="copyrightInfringements">
                      <h2>15. COPYRIGHT INFRINGEMENTS</h2>
                      <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Service infringes upon any copyright you own or control, please immediately notify us using the contact information provided below (a “Notification”). A copy of your Notification will be sent to the person who posted or stored the material addressed in the Notification. Please be advised that pursuant to applicable law you may be held liable for damages if you make material misrepresentations in a Notification. Thus, if you are not sure that material located on or linked to by the Service infringes your copyright, you should consider first contacting an attorney.</p>
                    </div>

                    <div class="termAndTermination">
                      <h2>16. TERM AND TERMINATION</h2>
                      <p>These Terms of Use shall remain in full force and effect while you use the Service. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SERVICE (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS OF USE OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICE OR DELETE ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</p>
                      <p>If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>
                    </div>

                    <div class="modificationsAndInterruptions">
                      ...
                      <p>We cannot guarantee the Service will be available at all times. We may experience hardware, software, or other problems or need to perform maintenance related to the Service, resulting in interruptions, delays, or errors. We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify the Service at any time or for any reason without notice to you. You agree that we have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to access or use the Service during any downtime or discontinuance of the Service. Nothing in these Terms of Use will be construed to obligate us to maintain and support the Service or to supply any corrections, updates, or releases in connection therewith.</p>
                    </div>

                    <div class="governingLaw">
                      <h2>18. GOVERNING LAW</h2>
                      <p>These conditions are governed by and interpreted following the laws of the United Kingdom, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. AccuraSoft Ltd. and yourself both agree to submit to the non-exclusive jurisdiction of the courts of London, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in the United Kingdom, or in the EU country in which you reside.</p>
                    </div>
                    ...
                    <div class="limitationsOfLiability">
                    ...
                    <div class="electronicCommunications">
                    ...
                    <div class="contactUs">
                      <h2>28. CONTACT US</h2>
                      <p>In order to resolve a complaint regarding the Service or to receive further information regarding use of the Service, please contact us either by filling out the <span class="body__text-span" @click="showContactForm = true">contact form</span> on the flamingotracker.com  website or at:</p>
                      <p>
                        AccuraSoft Ltd. <br>
                        ...
                        Covent Garden <br>
                        United Kingdom <br>
                        <a href="mailto:contact@flamingotracker.com">contact@flamingotracker.com</a>
                      </p>
                    </div>
...
export default {
  ...
  data() {
    return {
      titles: [
        { text: '1. AGREEMENT TO TERMS', value: 'agreementToTerms'},
        { text: '2. INTELLECTUAL PROPERTY RIGHTS', value: 'intellectualPropertyRights'},
        { text: '3. USER REPRESENTATIONS', value: 'userRepresentations'},
        { text: '4. FEES AND PAYMENT', value: 'feesAndPayment'},
        { text: '5. CANCELLATION', value: 'cancellation'},
        { text: '6. SOFTWARE', value: 'software'},
        { text: '7. PROHIBITED ACTIVITIES', value: 'prohibitedActivities'},
        { text: '8. USER GENERATED CONTRIBUTIONS', value: 'userGeneratedContributions'},
        { text: '9. CONTRIBUTION LICENSE', value: 'contributionLicense'},
        { text: '10. MOBILE APPLICATION LICENSE', value: 'mobileApplicationLicense'},
        { text: '11. SUBMISSIONS', value: 'submissions'},
        { text: '12. U.S. GOVERNMENT RIGHTS', value: 'usGovernmentRights'},
        { text: '13. SERVICE MANAGEMENT', value: 'serviceManagement'},
        { text: '14. PRIVACY NOTICE', value: 'privacyPolicy'},
        { text: '15. COPYRIGHT INFRINGEMENTS', value: 'copyrightInfringements'},
        { text: '16. TERM AND TERMINATION', value: 'termAndTermination'},
        { text: '17. MODIFICATIONS AND INTERRUPTIONS', value: 'modificationsAndInterruptions'},
        { text: '18. GOVERNING LAW', value: 'governingLaw'},
        { text: '19. DISPUTE RESOLUTION', value: 'disputeResolution'},
        { text: '20. CORRECTIONS', value: 'corrections'},
        { text: '21. DISCLAIMER', value: 'disclaimer'},
        { text: '22. LIMITATIONS OF LIABILITY', value: 'limitationsOfLiability'},
        { text: '23. INDEMNIFICATION', value: 'indemnification'},
        { text: '24. USER DATA', value: 'userData'},
        { text: '25. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES', value: 'electronicCommunications'},
        { text: '26. CALIFORNIA USERS AND RESIDENTS', value: 'californiaUsers'},
        { text: '27. MISCELLANEOUS', value: 'miscellaneous'},
        { text: '28. CONTACT US', value: 'contactUs'},
      ]
    }
  },
  methods: {

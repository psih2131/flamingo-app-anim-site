    ...
    <main class="main legal-main">
        <div class="container">
            ...
            <div class="controls">
                ...
                <label>Scroll {{ scrollVal }}: <input v-model="scrollVal" type="range" min="0" :max="scrollWidth"></label> <!-- 86400 * 7 -->
            </div>
...
export default {
    ...
    setup() {
        ...
        function generateGeoLog() {
            homeRegion = Math.floor(Math.random() * 2);
            let log = [];
            let awayNights = 0;
    ...
    methods: {
        ...
        getHomeRegion() {
            let r = ['New Jarsey State', 'New York State', 'NYC'];
        ...
        calcTravels() {
            ...
            for (let i = 0; i < this.log.length; i++) {
                const el = this.log[i];
                const regionsList = ['New Jarsey State', 'New York State', 'NYC'];
                let newTravel = {
